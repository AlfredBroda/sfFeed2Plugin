 ...
 * 
 * Ported to Symfony 2.x by Alfred Broda <alfred.broda@gmail.com>
 *
...
class sfAtom1Feed extends sfFeed {
    ...
    public function asXml() {
        return new Response($this->toXml(), 200, array(
                    'Content-Type' => 'application/atom+xml; charset=' . $this->getEncoding()
                ));
    }
